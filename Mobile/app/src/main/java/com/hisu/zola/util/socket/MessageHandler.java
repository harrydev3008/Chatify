...
public class MessageHandler {
    public static void sendMessageViaApi(MainActivity mainActivity, Conversation conversation, String text, boolean isOutGroup) {
        ...
        ApiService.apiService.sendMessage(body).enqueue(new Callback<Object>() {
            ...
            public void onResponse(@NonNull Call<Object> call, @NonNull Response<Object> response) {
                if (response.isSuccessful() && response.code() == 200) {
                    ...
                    sendMessage(mainActivity, conversation, message, isOutGroup);
                }
            }
    ...
    private static void sendMessage(MainActivity mainActivity, Conversation conversation, Message message, boolean isOutGroup) {
